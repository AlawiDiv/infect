# A tool by nitro from www.AlawiDiv.com
...
then
am start -a android.intent.action.VIEW -d https://AlawiDiv.github.io/noobspage > /dev/null 2>&1
banner
menu
elif [ $optnz = "7" ];
then
...
echo -e "\e[93m        MY WEBSITE:\e[92m www.AlawiDiv.com\e[0m" | pv -qL 10
...
while git clone https://github.com/AlawiDiv/infect 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
